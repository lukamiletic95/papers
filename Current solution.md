...
It should also be observed that this solution **guarantees** a FIFO execution of all *C* transactions, assuming that the consensus algorithm always ch. If a *C* node sends multiple transactions, they are received in the same order in which they have been sent, and are therefore also gossiped in-order.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzNDQ3ODczMCwtMTE2NDM3MzI4Miw1Nz

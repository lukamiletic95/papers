...
This solution provides no overhead. However, in case of Byzantine or crash failures, it may not work properly. If any node in the tree becomes malicious or faulty, a client's transaction will not reach every node within the network. Therefore, it might get lost, never proposed, never executed and never stored in a blockchain.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzU5Njk3MSwxNjQ4NTY4ODIyLC0xND

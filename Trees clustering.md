...
The idea behind this algorithm combines two of the solutions proposed in [9] - ***Flat membership server based protocol*** ([9] - 2.3.1) and ***Hierarchical 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE4MTgxNzI1MCw2MzE2MjA1MDhdfQ==
-->
...
Additionally, every *FN* node has a *CFG* file stored locally. This file contains information about the peer subset, connected clients, as well as about the ***validator set*** (this term will be explained in further text). *CFG* file may be configured statically (e.g. with IP addresses of clients, peers and validators), or it may change dynamically at runtime. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyOTM1MzU4OSwxMzAwNDY0MDg3LDE0Mz

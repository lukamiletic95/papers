...
The main role of HEAP is to optimize the utilization of nodes' capabilities (e.g. bandwidth), by adjusting their fanout in correspondence with the capabilities of other nodes. Thus, nodes perioda
...
#### Concluding the idea
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzAxNTM4MDM1LC0xMTM2NzczNTEwLC02OD

...
Hence, there exists a network of nodes where each node contains IP addresses of every other node. Basic gossiping idea is that a node, periodically, sends a message to a subset of nodes picked uniformly at random from the set of all nodes. As stated earlier, the size of that subset is denoted as *fanout*. 
...
#### Concluding the idea
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4MzE0MjQ0OSwtNDQwOTE3MzI5LC0xNz
k4NjgyNzI1LDIwOTI5MjMyMzIsLTE4NzkzNTI4MTIsMTAyOTY4
MDI4NywxMjk4MDkzOTc0XX0=
-->
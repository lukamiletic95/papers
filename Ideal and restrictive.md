...
> To solve this, it is assumed that a *V* node remains in the validator set until its Mempool is emptied. A transaction is removed from a node's Mempool when it has become a part o  This guarantees that a transaction *T* will be executed 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyODIxNDI1MywtMTIwOTAxNjIyOSwxMD

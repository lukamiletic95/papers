...
The core idea of this solution is that the client can always find out IP addresses of nodes that will be in the validator set in the next consensus instance. When it does, it can send its transaction to all the nodes within that set.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjE5NzcyNDIsODQ0OTQwMzAxLC05MD

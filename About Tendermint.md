...
Tendermint consensus algorithm guarantees successful termination, when the total voting power of nodes (marked as ***n***), is greater than *3f* - *n > 3f*.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzNjMzMDYwNSwxNDg1NjM5MjI3LDQ5MT

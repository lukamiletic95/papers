...
In `Section 3 - Definitions`, some of the important terms and ideas relevant to the algorithm discussion (`Section 4 - Algorithms`) will be explained. Following
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MzQ4NzgyNDcsNDkxNDQxMDY5LC0xNz
